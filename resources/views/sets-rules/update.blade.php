...
@section('title', 'Update advanced converter rule')
        ...
        <div class="row">
            <div class="col-md-12 offset-content">
                <div class="box box-primary">
                    <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('set-rules-update', [$model]) }}"
                          method="post" autocomplete="off" novalidate>
                        {{ csrf_field() }}
                        <div class="box-header with-border">
                            <div class="box-title">
                                <h1>Set update {{ $model->title }}</h1>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-4">
                                    <input name="title" id="title" class="form-control" value="{{ old('title') ?: $model->title }}">
