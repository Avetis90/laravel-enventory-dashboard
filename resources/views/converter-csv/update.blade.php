        ...
        <div class="row">
            <div class="col-md-12 offset-content">
                <div class="box box-primary">
                    <form class="form-horizontal" enctype="multipart/form-data" action="{{ route('converter-update', [ 'converter'=> $model]) }}"
                          method="post" autocomplete="off" novalidate>

                        <div class="box-header with-border">
                            <div class="box-title">
                                <h1>Converter Update {{ $parsers[$model->converter_type] }}</h1>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-sm-4">
                                    <select name="converter_type" id="converter_type" class="form-control">
                                        ...
                                        @foreach ($parsers as $key => $value)
                                            <option value="{{ $key }}" {{ (old('converter_type') ?: $model->converter_type)  === $key ? 'selected' : "" }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group {{ $errors->has('description_cn') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-4">
                                    <textarea name="description_cn" id="description_cn" class="form-control">{{  old('description_cn') ?:$model->description_cn }}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('service_options') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-4">
                                    <input name="service_options" id="service_options" class="form-control" value="{{ old('service_options') ?: $model->service_options }}">
                            ...
                            <div class="form-group {{ $errors->has('battery_packing') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-4">
                                    <input name="battery_packing" id="battery_packing" class="form-control" value="{{ old('battery_packing') ?: $model->battery_packing }}">
                            ...
                            <div class="form-group {{ $errors->has('battery_type') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-4">
                                    <input name="battery_type" id="battery_type" class="form-control" value="{{  old('battery_type') ?:$model->battery_type }}">
                            ...
                            <div class="form-group {{ $errors->has('prefix') ? 'has-error' : ''}}" >
                                ...
                                <div class="col-sm-4">
                                    <input name="prefix" id="prefix" class="form-control" value="{{  old('prefix') ?: $model->prefix }}">
